...
class TestOrasContent(RouteBase):
    ...
    def test_tag_list_limit(self):
        ...
        with self.fake_admin_auth():
            ret = self.client.get(
                f"/v2/{image.entityName}/{image.collectionName}/{image.containerName}/tags/list?n=1"
            )
        self.assertEqual(ret.status_code, 200)
        ret_data = ret.get_json()
        self.assertDictEqual(
    ...
    def test_tag_list_limit_zero(self):
        ...
        with self.fake_admin_auth():
            ret = self.client.get(
                f"/v2/{image.entityName}/{image.collectionName}/{image.containerName}/tags/list?n=0"
            )
        self.assertEqual(ret.status_code, 200)
        ret_data = ret.get_json()
        self.assertDictEqual(
            {"name": f"{image.entityName}/{image.collectionName}/{image.containerName}", "tags": []}, ret_data
        )
    ...
    def test_tag_list_limit_more(self):
        ...
        with self.fake_admin_auth():
            ret = self.client.get(
                f"/v2/{image.entityName}/{image.collectionName}/{image.containerName}/tags/list?n=3"
            )
        self.assertEqual(ret.status_code, 200)
        ret_data = ret.get_json()
        self.assertDictEqual(
            {"name": f"{image.entityName}/{image.collectionName}/{image.containerName}", "tags": ["oink"]}, ret_data
        )
    ...
    def test_tag_list_last(self):
        ...
        with self.fake_admin_auth():
            ret = self.client.get(
                f"/v2/{image.entityName}/{image.collectionName}/{image.containerName}/tags/list?last=007"
            )
        self.assertEqual(ret.status_code, 200)
        ret_data = ret.get_json()
        self.assertDictEqual(
    ...
    def test_tag_list_last_count(self):
        ...
        with self.fake_admin_auth():
            ret = self.client.get(
                f"/v2/{image.entityName}/{image.collectionName}/{image.containerName}/tags/list?last=007&n=1"
            )
        self.assertEqual(ret.status_code, 200)
        ret_data = ret.get_json()
        self.assertDictEqual(
    ...
    def test_tag_list_last_not_found(self):
        ...
        with self.fake_admin_auth():
            ret = self.client.get(
                f"/v2/{image.entityName}/{image.collectionName}/{image.containerName}/tags/list?last=muuh"
            )
    ...
    def test_delete_tag_not_found(self):
        ...
        with self.fake_admin_auth():
            ret = self.client.delete(
                f"/v2/{image.entityName}/{image.collectionName}/{image.containerName}/manifests/v2oink"
            )
        self.assertEqual(ret.status_code, 404)
    ...
    def test_delete_blob_not_found(self):
        ...
        with self.fake_admin_auth():
            ret = self.client.delete(
                f"/v2/{image.entityName}/{image.collectionName}/{image.containerName}/blobs/sha256:{image.hash.replace('sha256.', '')}oink"
            )
        self.assertEqual(ret.status_code, 404)
